...
pd.DataFrame(np.array(mae_pred).reshape(1,-1)).to_csv(f'result/val/trNITF_{data}_mae_pred.csv')
pd.DataFrame(np.array(mae_pred2).reshape(1,-1)).to_csv(f'result/test/trNITF_{data}_mae_pred.csv')
...
pd.DataFrame(np.array(mse_pred).reshape(1,-1)).to_csv(f'result/val/trNITF_{data}_mse_pred.csv')
pd.DataFrame(np.array(mse_pred2).reshape(1,-1)).to_csv(f'result/test/trNITF_{data}_mse_pred.csv')
...
pd.DataFrame(np.array(smape_pred).reshape(1,-1)).to_csv(f'result/val/trNITF_{data}_smape_pred.csv')
pd.DataFrame(np.array(smape_pred2).reshape(1,-1)).to_csv(f'result/test/trNITF_{data}_smape_pred.csv')
...
pd.DataFrame(np.array(mase_pred).reshape(1,-1)).to_csv(f'result/val/trNITF_{data}_mase_pred.csv')
pd.DataFrame(np.array(mase_pred2).reshape(1,-1)).to_csv(f'result/test/trNITF_{data}_mase_pred.csv')
...
pd.DataFrame(np.array(mape_pred).reshape(1,-1)).to_csv(f'result/val/trNITF_{data}_mape_pred.csv')
pd.DataFrame(np.array(mape_pred2).reshape(1,-1)).to_csv(f'result/test/trNITF_{data}_mape_pred.csv')
